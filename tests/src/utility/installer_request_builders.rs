...
use super::constants::{
    ACCOUNT_1_ADDR, ACCOUNT_1_PUBLIC_KEY, ACCOUNT_2_ADDR, ARG_AMOUNT, ARG_CURRENCY, ARG_DECIMALS,
    ARG_MASTER_MINTER, ARG_NAME, ARG_OWNER, ARG_RECIPIENT, ARG_SPENDER, ARG_SYMBOL,
    ...
    CSPR_USD_TEST_CONTRACT_WASM, KEY, METHOD_APPROVE, METHOD_APPROVE_AS_STORED_CONTRACT,
